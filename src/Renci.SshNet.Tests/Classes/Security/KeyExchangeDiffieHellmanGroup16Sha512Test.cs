...
namespace Renci.SshNet.Tests.Classes.Security
{
    ...
    public class KeyExchangeDiffieHellmanGroup16Sha512Test : TestBase
    {
        ...
        {
            byte[] bytes = _group16.GroupPrime.ToByteArray().Reverse();
