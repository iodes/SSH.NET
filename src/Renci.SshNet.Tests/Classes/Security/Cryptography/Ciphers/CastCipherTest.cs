...
namespace Renci.SshNet.Tests.Classes.Security.Cryptography.Ciphers
{
    ...
    public class CastCipherTest : TestBase
    {
        ...
        public void Encrypt_128_CBC()
        {
            ...
            var output = new byte[]
            {
                0x32, 0xef, 0xbd, 0xac, 0xb6, 0xfd, 0x1f, 0xae, 0x1b, 0x13, 0x5f, 0x31, 0x6d, 0x38, 0xcd, 0xb0, 0xe3, 0xca, 0xe1, 0xbc, 0xf8, 0xa7, 0xc2, 0x31, 0x62, 0x14, 0x3a, 0x9a, 0xda, 0xe3, 0xf8, 0xc8, 0x70, 0x87, 0x53, 0x21, 0x5d, 0xb7, 0x94, 0xb7, 0xe8, 0xc6, 0x9d, 0x46, 0x0c, 0x6d, 0x64, 0x6d
            };

            var testCipher = new CastCipher(key, new CbcCipherMode(iv), null);
            byte[] r = testCipher.Encrypt(input);
        ...
        public void Decrypt_128_CBC()
        {
            ...
            var testCipher = new CastCipher(key, new CbcCipherMode(iv), null);
            byte[] r = testCipher.Decrypt(output);
        ...
        public void CastCipherConstructorTest()
        {
            ...
            var target = new CastCipher(key, mode, padding);
        ...
        public void DecryptBlockTest()
        {
            ...
            CipherMode mode = null; // TODO: Initialize to an appropriate value
            CipherPadding padding = null; // TODO: Initialize to an appropriate value
            var target = new CastCipher(key, mode, padding); // TODO: Initialize to an appropriate value
