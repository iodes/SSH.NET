    ...
    */
        ...
        : AbstractECMultiplier
    {
        ...
        protected override ECPoint MultiplyPositive(ECPoint p, BigInteger k)
        {
            ...
            var width = System.Math.Max(2, System.Math.Min(16, GetWindowSize(k.BitLength)));

            var wnafPreCompInfo = WNafUtilities.Precompute(p, width, true);
